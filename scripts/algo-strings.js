...
const extendedBoothsAlgo = 
    ...
    <b>A. &nbsp; Represent the operands in two's complement.</b> <br>
        <span class = "indented">1. &nbsp; If the user enters a decimal number, it is represented
        using the fewest number of bits.</span><br>
        <span class = "indented">2. &nbsp; If the user enters a binary number, the number of bits follows the user's
        input. </span><br>
    ...
    <b>C. &nbsp; Convert the multiplier to its extended Booth's equivalent.</b><br>
        ...
        perform sign extension.</span> <br>
        <span class = "indented">3. &nbsp; Perform bit-pair recoding starting at the least significant bit.</span>
